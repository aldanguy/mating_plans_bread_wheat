...
titre_pheno_output <- variables[9]
  ...
  # titre_genotyping <-  "/work/adanguy/these/croisements/amont/GSE50558_CFD_matrix_GEO.txt"             
  # titre_map <-"/work/adanguy/these/croisements/amont/Complete-map-3133142.txt"                
  # titre_correspondance_ID  <- "/work/adanguy/these/croisements/amont/GPL17677-31783.txt"                      
  # titre_pheno <- "/work/adanguy/these/croisements/amont/PhenotypicDataDent.csv"                  
  # titre_function_sort_genotyping_matrix <- "/work/adanguy/these/croisements/scripts/sort_genotyping_matrix.R"              
  # nbcores <-  "2"                                                                             
  # titre_genotyping_output <-"/work2/genphyse/dynagen/adanguy/croisements/290421_mais/prepare/genotyping.txt"
  # titre_markers_output <- "/work2/genphyse/dynagen/adanguy/croisements/290421_mais/prepare/markers.txt"   
  # titre_pheno_output <-  "/work2/genphyse/dynagen/adanguy/croisements/290421_mais/prepare/lines.txt" 
  # 
...
pheno <- pheno %>% filter(ID %in% colnames(g3))
