...
cp ${r_scripts}renumf90.par ${r_log}renumf90_${type}.par #add diagional et Gtest
...
cp ${r_save2}renf90.par ${r_log}renf90_${type}.par # remove weights

${r_save2}airemlf90 ${r_log}renf90_${type}.par > ${r_log}airemlf90_${type}.out # add user file to estimate variance component
...
${r_save2}blupf90 ${r_log}renf90_${type}.par > ${r_log}blupf90_${type}.out #add user file inv, remove snp an most options
