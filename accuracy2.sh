...
ID3=sTRUE_iTRUE_q300rand_hNA_gNA_p${population}_n${population_ID}_mWE_CONSTRAINTS
info="population_predict_population"


criteria_estimated=${r_big_files}article/criteria/criteria_${ID0}.txt
...
titre_output=${r}ratio_iESTIMATED_p${population}_n${population_ID}.txt
titre_correlations_output=${r}correlations_iESTIMATED_p${population}_n${population_ID}.txt

v1=${titre_criteria}
v2=${titre_output}
v3=${info}
v4=${titre_correlations_output}
...
titre_criteria=${r_big_files}article/criteria/criteria_${ID3}.txt
titre_output=${r}ratio_iTRUE_p${population}_n${population_ID}.txt
titre_correlations_output=${r}correlations_iTRUE_p${population}_n${population_ID}.txt
