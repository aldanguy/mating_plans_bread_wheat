...
base=/work/jelsen/croisements/scripts/01_base_cr_250222_jelsen.sh

source ${base}


file_jobs=${r0}jobs_pipeline1.txt
job_name=p1
job_out=${r0}p1.out
...
job=$(sbatch -o ${job_out} -J ${job_name} -p workq --mem-per-cpu=10G --parsable ${r_scripts}pipeline2.sh ${v1} ${v2} ${v3} ${v4} ${v5} ${v6} ${v7} ${v8} ${v9} ${v10} ${v11} ${v12} ${v13} ${v14} ${v15} ${v16} ${v17} ${v18} ${v19} ${v20} ${v21} ${v22} ${v23} ${v24} ${v25} ${v26} ${v27} ${v28} ${v29})
...
r=${r_big_files}article/true_GBLUP/
...
job=$(sbatch -o ${job_out} -J ${job_name} -p workq --mem-per-cpu=10G --parsable ${r_scripts}pipeline2_TRUE.sh ${v1} ${v2} ${v3} ${v4} ${v5} ${v6} ${v7} ${v8} ${v9} ${v10} ${v11} ${v12} ${v13} ${v14} ${v15} ${v16} ${v17} ${v18} ${v19} ${v20} ${v21} ${v22} ${v23} ${v24} ${v25} ${v26} ${v27} ${v28} ${v29})
