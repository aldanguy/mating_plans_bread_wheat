...
log_renumf90_1=${r_log}renumf90_${ID}_TRUE.out
param_airemlf90=${r_gblup_param}renf90_${ID}_TRUE.par
log_airemlf90=${r_log}airemlf90_${ID}_TRUE.out
param_renumf90_2=${r_gblup_param}postGSf90_1_${ID}_TRUE.par
log_renumf90_2=${r_log}postgsf90_1_${ID}_TRUE.out
param_postGSf90=${r_gblup_param}postGSf90_2_${ID}_TRUE.par
log_postGSf90=${r_log}postGSf90_2_${ID}_TRUE.out
