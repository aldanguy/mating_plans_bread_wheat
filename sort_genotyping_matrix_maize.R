...
sort_genotyping_matrix <- function(genotyping_matrix_file, markers_file){
  ...
  colonnes_marqueurs <- colonnes_genotyping_matrix_file[grep("rs", colonnes_genotyping_matrix_file)]
  colonnes_autres <- colonnes_genotyping_matrix_file[grep("rs", colonnes_genotyping_matrix_file, invert=T)]
